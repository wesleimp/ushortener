...
config :ushortener, Ushortener.Repo,
  ...
  database: System.get_env("USHORTENER_DATABASE_DATABASE", "ushortener_dev"),
...
config :ushortener_web, UshortenerWeb.Endpoint,
  ...
  watchers: [
    node: [
      ...
      "development",
      "--watch-stdin",
      cd: Path.expand("../apps/ushortener_web/assets", __DIR__)
    ]
  ]
...
config :ushortener_web, UshortenerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ushortener_web/(live|views)/.*(ex)$",
      ~r"lib/ushortener_web/templates/.*(eex)$"
    ]
  ]
